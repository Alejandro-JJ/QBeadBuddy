...
#meanR = []
#for t in range(0,60):
#    print(f'Analyzing timepoint {t}')
#    imgpath = '/media/alejandro/EXPERIMENTS/20190514/Beads_tp'+str(t).zfill(2)+'.tif'
#    im_beads, n, meanradius = MasterSegmenter(imgpath,t,threshold=1000, show_plots=False, savepics=True)
#    N.append(n)
#    meanR.append(meanradius)
#
#fig,ax = plt.subplots(1,2,figsize=(8,4))
#ax[0].plot(N, 'g-o'), ax[0].grid(), ax[0].title.set_text('# Beads')
#ax[1].plot(meanR, 'ro-'), ax[1].grid(), ax[1].title.set_text('Mean bead radius')
#
##%% Can I segment nuclei? YES
#imgpath = '/media/alejandro/EXPERIMENTS/20201116_flama/TP59/H2AmCherry_tp59.tif'
#
#im_nuclei, n, meanradius = MasterSegmenter(imgpath, 0, threshold=50)
#imsave('/media/alejandro/Coding/BIG_BeadBuddy/COSA.tif', im_nuclei)
